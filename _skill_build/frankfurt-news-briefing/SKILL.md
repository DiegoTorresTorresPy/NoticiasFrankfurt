...
description: Generar briefings locales de Frankfurt con noticias de Google News RSS, clima de Open-Meteo, festivos cercanos de Nager.Date y agenda deportiva desde TheSportsDB, sin depender de otro LLM. Usar cuando el usuario pida noticias de Frankfurt, huelgas, alertas, movilidad, contexto social, economia/finanzas de Alemania, cultura/conciertos, previsión de lluvia/temperatura, fin de semana, festivos cercanos o agenda deportiva de Champions, Formula 1, MotoGP, Alcaraz, Real Madrid, Barcelona y Atletico de Madrid.
---
...
5. Priorizar impacto practico:
   ...
   - economia, finanzas y cultura de Alemania cuando aporten contexto
   - lluvia, temperatura actual y del dia siguiente
   - sabado y domingo si aparecen en `weather.weekend`
   - festivos cercanos si existen
   - agenda deportiva si el usuario la pide o si viene bien incluirla
...
- Si el usuario pide deporte o agenda, priorizar `sports` sobre los titulares generales.
